...
\begin{document}
\maketitle
\noindent\textbf{Historical draft.} The mathematical statements in this
file predate the corrected Markdown edition. Read
\texttt{SHORT\_NOTE.md} and \texttt{FORMAL\_THEOREMS.md}; the counterexamples
and replacements are documented in \texttt{ORIGINAL\_NOTE\_REVIEW.md}.
